...
-include vendor/alps/imoz7/BoardConfigVendor.mk

LOCAL_FOLDER := device/alps/imoz7
COMMON_FOLDER := device/alps/common
...
TARGET_KERNEL_SOURCE := kernel/alps/imoz7/kernel
TARGET_KERNEL_CONFIG := mediatek-configs
TARGET_KERNEL_CUSTOM_TOOLCHAIN := arm-linux-androideabi-4.9.x
TARGET_KERNEL_CUSTOM_TOOLCHAIN_BIN := arm-linux-androideabi-
TARGET_KERNEL_PROVIDES_BUILD_COMMANDS := kernel/alps/imoz7/imoz7.mk
TARGET_KERNEL_MTK_HEADER := $(LOCAL_FOLDER)/emmctools/header
NEEDS_KERNEL_COPY := true

KERNEL_MAKE_PARAMETERS := TARGET_PRODUCT=imoz7 MTK_ROOT_CUSTOM=$(TARGET_KERNEL_SOURCE)/mediatek/custom 
...
TARGET_BOOTLOADER_BOARD_NAME := imoz7
...
#This is provided by the alps sources (partition_define.h). Some info are not used in CM9 real definitions
#define KB(1024)
#6144*KB
...
#525312*KB
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 831520768
BOARD_CACHEIMAGE_PARTITION_SIZE := 537919488
#1573888*KB
BOARD_USERDATAIMAGE_PARTITION_SIZE := 537919488
BOARD_FATIMAGE_PARTITION_SIZE := 1943240704
